      ...
      <div className="container mx-auto px-4">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-neutral-200 text-sm mb-4">
            Discover delicious recipes from around the world, save your
            favorites, and become a better cook.
          </p>
        ...
        <div className="mt-10 pt-6 border-t border-neutral-400 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="text-neutral-200 hover:text-white text-sm transition-all"
            >
              Privacy Policy
            </a>
            <a
